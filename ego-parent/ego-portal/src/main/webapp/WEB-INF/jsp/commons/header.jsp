...
<div id="o-header-2013">
	<div class="w" id="header-2013">
		...
		<div id="search-2013">
			<div class="i-search ld">
				...
				<div class="form">
					...
					<input type="button" value="搜索" class="button" onclick="javascript:window.location.href='http://search.ego.com/search.html?q=' + encodeURIComponent(document.getElementById('key').value);return false;" clstag="homepage|keycount|home2013|03a">
				</div>
			</div>
		...
		<div id="my360buy-2013">
			<dl>
				<dt class="ld"><s></s><a href="http://order.ego.com/show/my-info" clstag="homepage|keycount|home2012|04a">我的易购</a><b></b></dt>
				<dd>
		...
		<div id="settleup-2013" clstag="homepage|keycount|home2013|05a">
			<dl>
				<dt class="ld"><s></s><span class="shopping"><span id="shopping-amount"></span></span><a href="http://cart.ego.com/cart/cart.html" id="settleup-url">去购物车结算</a> <b></b> </dt>
<!-- 				<dd>
					<div class="prompt">
						<div class="loading-style1"><b></b>加载中，请稍候...</div>
					</div>
